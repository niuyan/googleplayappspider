...
class GoogleplayspiderEN(CrawlSpider):
    # define the name of the spider
    name = "GooglePlaySpiderEN"
    ...
    '''
    rules = (
        Rule(LinkExtractor(allow=(r'apps/details',), deny=(r'reviewId')), follow=True, callback='parselink'),
    ...
    def parselink(self, response):
        ...
        item["Item_name"] = response.xpath('//*[@itemprop="name"]/a/span/text()').extract_first().encode("utf-8")
